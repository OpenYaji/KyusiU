  ...
  return (
    <div className="py-6">
        ...
        <Card className="bg-gradient-to-r from-blue-900 to-blue-700 text-white overflow-hidden">
          <CardContent className="p-6 flex flex-col md:flex-row justify-between items-center">
            <div className="space-y-4 mb-4 md:mb-0">
              ...
              <h1 className="text-3xl font-bold">Welcome Back, John Rey!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="bg-gradient-to-r from-blue-900 to-blue-700 text-white hover:translate-y-[-10px] transition-transform duration-300 h-full">
        ...
        <Card className="bg-gradient-to-r from-blue-900 to-blue-700 text-white hover:translate-y-[-10px] transition-transform duration-300 h-full">
          <CardContent className="p-6 flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg">2 Upcoming</p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-lg group h-64">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-gray-800 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="font-bold text-gray-800 dark:text-white">QCUCAT</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Latest updates on college admission test.</p>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-lg group h-64">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-gray-800 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="font-bold text-gray-800 dark:text-white">Campus Event</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Join us for the upcoming campus event.</p>
                  <a href="#" className="text-blue-900 dark:text-blue-400 inline-block mt-2">
                    <ExternalLink className="h-4 w-4" />
                  </a>
                </div>
