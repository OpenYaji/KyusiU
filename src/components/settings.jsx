    ...
    <div className="py-6">
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <Button
          ...
          className={activeTab === "account" ? "bg-blue-900 hover:bg-blue-800" : ""}
        >
          Account
        </Button>
        <Button
          ...
          {activeTab === "account" && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input id="name" defaultValue="John Rey Calipes" />
              </div>

              <div className="flex flex-col gap-2">
                <Label htmlFor="email">Email:</Label>
                <Input id="email" type="email" defaultValue="johnrey@example.com" />
              </div>

              <Button className="bg-blue-900 hover:bg-blue-800">Change Password</Button>
            </div>
          )}
